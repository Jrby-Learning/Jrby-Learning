...
import com.neusoftedu.admin.pojo.CoursePreview;

import java.util.List;

public interface CoursePreviewService {
    //分页查询所有预告
    List<CoursePreview> pageCoursePreview(int pageNum, int pageSize);
    ...
    //搜索课程预告
    List<CoursePreview> searchCoursePreview(CoursePreview coursePreview, int pageNum, int pageSize);
