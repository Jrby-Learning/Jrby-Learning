package com.neusoftedu.admin.controller.sms;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;
import io.swagger.annotations.ApiParam;
import org.springframework.web.bind.annotation.*;
import com.neusoftedu.admin.service.mail.IMailService;
import com.neusoftedu.admin.service.sms.AliYunSmsService;
import com.neusoftedu.admin.util.redis.RedisUtil;
import com.neusoftedu.admin.util.tools.ResultVO;
import com.neusoftedu.admin.util.tools.Tools;
...
public class SMSController {
    ...
    public ResultVO sendCodeMail(@ApiParam("收件人") @RequestParam("to") String to,
                                 @ApiParam("用户名") @RequestParam("userName") String userName) {
        Map<String, Object> data = new HashMap<>();
    ...
    public ResultVO phoneCheckCode(@ApiParam("手机号") @RequestParam("phone") String phone) {
        String code = Tools.randomCode();
