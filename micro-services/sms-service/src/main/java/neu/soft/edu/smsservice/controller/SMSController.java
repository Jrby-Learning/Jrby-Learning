package neu.soft.edu.smsservice.controller;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;
import io.swagger.annotations.ApiParam;
import neu.soft.edu.smsservice.feign.MailClient;
import neu.soft.edu.smsservice.feign.param.MailParam;
import neu.soft.edu.smsservice.param.SendCodeMailParam;
import neu.soft.edu.smsservice.param.SendCodePhoneParam;
import neu.soft.edu.smsservice.service.AliYunSmsService;
import neu.soft.edu.smsservice.util.redis.RedisUtil;
import neu.soft.edu.smsservice.util.tools.ResultVO;
import neu.soft.edu.smsservice.util.tools.Tools;
...
public class SMSController {
    ...
    public ResultVO sendSimpleMail(@ApiParam("收件人") @RequestParam("to") String to,
        ...
        mailClient.sendSimpleMail(new MailParam(to, subject, content, null, null));
    ...
    public ResultVO sendHtmlMail(@ApiParam("收件人") @RequestParam("to") String to,
        ...
        //boolean send = mailClient.sendHTMLMail(to, subject, content);
    ...
    public ResultVO sendAttachmentsMail(@ApiParam("收件人") @RequestParam("to") String to,
        ...
        //boolean send = mailClient.sendAttachmentsMail(to, subject, content,filePath);
    ...
    public ResultVO sendRegisterMail(@ApiParam("收件人") @RequestParam("to") String to,
        ...
        // boolean send = mailClient.sendTemplateMail(to, "注册成功", "mail/register", data);
    ...
    public ResultVO sendCodeMail(@RequestBody SendCodeMailParam sendCodeMailParam) {
        ...
        // data.put("date",new Date());
        data.put("year", Calendar.getInstance().get(Calendar.YEAR));
        // boolean send = mailClient.sendTemplateMail(to, "操作验证码", "mail/code", data);
