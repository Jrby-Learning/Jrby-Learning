...
import neu.soft.edu.coinservice.feign.MessageClient;
...
import neu.soft.edu.coinservice.util.redis.RedisUtil;
import neu.soft.edu.coinservice.util.redis.UserSign;
...
public class UserSignController {
    ...
    public ResultVO sign() {
        ...
        if(!userSign.doSign(userId, today)){
            ...
            if(isSuccess){
                ...
                return ResultVO.success("签到成功，积分+"+coin);
            }else{
    ...
    public ResultVO checkSign() {
        ...
        //查询是否有新消息
        boolean newMessage = messageClient.newMessageState(userId);
