package neu.soft.edu.mailservice.service.impl;
...
public class IMailServiceImpl implements IMailService {
    ...
    public boolean sendHtmlMail(String to, String subject, String content){
        try {
            ...
            logger.error("html邮件发送失败->message:{}",e.getMessage());
            return false;
        }
    }
    ...
    public boolean sendAttachmentsMail(String to, String subject, String content, String filePath){
        try {
            ...
            logger.error("附件邮件发送失败->message:{}",e.getMessage());
            return false;
        }
    }
     ...
     */
    @Override
    public boolean sendTemplateMail(String to, String subject,String template, Map<String,Object> data){
        try {
