package neu.soft.edu.uploadservice.controller;
...
import neu.soft.edu.uploadservice.feign.ResourceClient;
import neu.soft.edu.uploadservice.feign.UserClient;
import neu.soft.edu.uploadservice.feign.pojo.ResourceList;
import neu.soft.edu.uploadservice.feign.pojo.User;
import neu.soft.edu.uploadservice.util.tools.PropertiesUtil;
import neu.soft.edu.uploadservice.util.tools.ResultVO;
...
public class UploadController {
    ...
    public ResultVO avatarUpload(@ApiParam("上传的文件") @RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            Boolean isSuccess = userClient.updateUser(user);
            if(isSuccess){
                return ResultVO.success("上传成功",data);
            }
    ...
    public void downloadFile(HttpServletResponse response,Integer resourceId) throws UnsupportedEncodingException {
        ...
        ResourceList resourceList = resourceClient.queryResourceById(resourceId);
