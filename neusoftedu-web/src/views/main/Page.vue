  ...
  <el-container class="page">
    ...
    <el-header class="el-header">
      <el-menu router :default-active="$route.path" mode="horizontal" class="navigation" text-color="#000" active-text-color="#409EFF">
        ...
        <el-menu-item index="/special-training">线下营</el-menu-item>
        <el-menu-item style="border-bottom: 1px solid transparent!important;">
          <el-input placeholder="请输入内容查找" v-model="queryKey" @keyup.enter.native="searchCourse(queryKey)" style="width: 450px">
          ...
          <div v-if="token">
            ...
            <el-popover
              ...
              <div class="title">
                ...
                <span class="gold" title="积分" @click="toGold">
    ...
    <el-footer class="el-footer">
      <div class="friend-chain">
        <ul>
          <li>友情链接 :</li>
          <li><a href="https://github.com/Jrby-Learning" target="_blank" title="开发者团队">开发者团队</a></li>
      ...
      <div class="description">
        ...
        <div class="about">
          ...
          <div>
            <h3>4008-823-823</h3>
            <p>周一至周日 00:00 - 24:00</p>
            <p>邮箱：email@email.mt</p>
            <p>地址：辽宁省沈阳市浑南区创新路195号<br>东北大学浑南校区</p>
          </div>
        </div>
      </div>
      <div class="copyright">© 2022 - {{new Date().getFullYear()}} 东软集团版权所有</div>
    </el-footer>
  </el-container>
</template>
...
<style scoped>
  ...
  .el-footer .description{
    ...
    border-top: 2px solid #1d4c82 !important;
  }
