<template>
  <div class="login-page">
    <div class="login-header">
      ...
      <span>服务热线: 4008 823 823</span>
    </div>
    <div class="login-box">
      <div class="left-half">
        <div class="logo">
          <el-image style="width: 220px; height: 70px" :src="logoImg" fit="fill"></el-image>
        </div>
        <ul class="geek-slide">
          <li>
            <i class="iconfont iconzuhejiekou"></i>
            <span class="title">自由</span>
            <span class="description">允许多种课程自由组合</span>
          </li>
          <li>
            <i class="iconfont iconyiduiyigoutong"></i>
            <span class="title">方便</span>
            <span class="description">随时随地学遍各种课程</span>
          </li>
          <li>
            <i class="iconfont icongaoxiao"></i>
            <span class="title">高效</span>
            <span class="description">资深行业专家亲自讲授</span>
          </li>
        </ul>
      </div>
...
.login-page{
  width: 100%;
  height: 100vh;
  /*background: #1d4c82 url(../../assets/login/newbg.png) center bottom no-repeat;*/
  background: #1d4c82 center bottom no-repeat;
}
