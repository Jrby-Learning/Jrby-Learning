  ...
  <div class="coin">
    ...
    <div class="gold-container">
      <el-card class="gold-card detailed" shadow="hover">
        ...
        <p class="gold-content" style="margin-bottom: 10px;">积分余额: <span style="color:#FF6633">{{userCoin}}</span></p>
        ...
        <div class="link">
          <el-popover
            ...
            trigger="hover">
            <div class="gold-help">
              <h6 class="title">积分有什么用？</h6>
              <ul>
                <li>积分可用于兑换课程资料</li>
                <li>积分还可用于参加活动</li>
              </ul>
              <h6 class="title">如何获得积分？</h6>
              <ul>
                <li>每日签到可获得积分</li>
                <li>开通VIP将会赠送积分</li>
              </ul>
              <h6 class="title">签到获取积分规则！</h6>
              <ul>
                <li>每日签到基础赠送20个</li>
                <li>每连续签到1天，多赠送5个</li>
                <li>最大连续签到上限为7天</li>
            ...
            <el-link type="primary" slot="reference" style="height: 20px">积分帮助<i class="el-icon-question"/> </el-link>
          </el-popover>
      ...
      <el-card class="gold-card" shadow="none">
        <div slot="header">
          ...
          <span style="font-weight: 600;">积分记录</span>
        </div>
...
<style>
.coin .el-card__header{
  padding: 10px 20px;
  border: 1px solid #EBEEF5;
  position: relative;
}

.coin .detailed .el-card__body{
  padding: 0 20px;
